...
if( class_exists( 'CSF' ) ) {
	...
	$breadcrumb 	= $adiya['archive_breadcrumb'];
	$bsidebar 		= $adiya['archive_sidebar'];
	$titles 		= $adiya['archive_titles'];
	$column 		= $adiya['archive_column'];
	$background 	= $adiya['archive_background'] ? $adiya['archive_background']['url'] : get_template_directory_uri(). "/assets/images/header/07_header.jpg";
	$padding 		= $adiya['archive_breadcrumb_padding'];
}
else{
	$breadcrumb 	= true;
	$bsidebar 		= true;
...
<section class="blog-page py-100">
	<div class="container">
		...
		<div class="sec-title home-3">
			<div class="row">
				<?php if( $adiya['archive_sheading'] || $adiya['archive_stitle']  ):?>
				<div class="col-lg-5">
					<?php if($adiya['archive_sheading'] ):?>
						<h2><?php echo esc_html($adiya['archive_sheading']);?></h2>
					<?php 
						endif;
						if($adiya['archive_stitle'] ):
					?>
						<h3><?php echo esc_html($adiya['archive_stitle']);?></h3>
					<?php endif;?>
				</div>
				<?php 
					endif;
					if( $adiya['archive_sdesc'] ):
				?>
				<div class="col-lg-5 d-flex align-items-center">
					<p class="sec-explain"><?php echo wp_kses( $adiya['archive_sdesc'] , adiya_expanded_alowed_tags()); ?></p>
				</div>
				<?php endif;?>
			</div>
		</div>
